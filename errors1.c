 ...
 * Return: 0 converted number otherwise -1 on error
 */
int _erratoi(char *s)
{
	int i = 0;
 ...
 * Return: 0 if no numbers in string are converted number otherwise
 *        -1 on error
 */
...
/**
 * convert_number - converter, a clone of i to a
 * @num: number
 * @base: base
